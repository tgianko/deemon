...
def infer_syntactic_type(values):
    ...
    # If not, check for special case FLOAT_TYPE > INT_TYPE, else it has to be a STRING_TYPE
...
class BasicTypeDEA:
    ...
    DEA = [[STRING_STATE, STRING_STATE, STRING_STATE], [INT_STATE, FLOAT_STATE, STRING_STATE], [FLOAT_STATE, STRING_STATE, STRING_STATE], [INT_STATE, FLOAT_STATE, STRING_STATE]]
